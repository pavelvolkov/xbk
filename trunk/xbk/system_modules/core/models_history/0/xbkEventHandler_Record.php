...
class xbkEventHandler_Record extends Doctrine_Record
{
    ...
    public function setTableDefinition()
    {
        ...
        $this->setTableName($CONFIG['db']['table_prefix'].'core_event_handlers');
        ...
        $this->hasColumn('event', 'string', 50, array('notnull' => true));
        $this->hasColumn('event_module', 'string', 50, array('notnull' => true));
    }
